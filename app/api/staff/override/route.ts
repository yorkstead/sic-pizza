...
export async function POST(req: NextRequest) {
  try {
    ...
    const { managerPin, action = "PROTECTED_ACTION", reason = "Manager Override Authorization", locationId = "loc_downtown" } = body;
    ...
    return NextResponse.json({ overrideToken: result.overrideToken, managerName: result.managerName });
  } catch (err: unknown) {
